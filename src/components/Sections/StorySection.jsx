        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
          ...
          <div>
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-6">
              Emirist has been at the forefront of luxury timepiece craftsmanship for over three decades. Our commitment to excellence and precision has made us a trusted name among watch enthusiasts worldwide.
            </p>
