        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4 mt-4">
            <div className={`flex items-center gap-2 ${step >= 1 ? 'text-[var(--primary-color)]' : 'text-gray-600'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${step >= 1 ? 'border-[var(--primary-color)] bg-[var(--primary-color)]' : 'border-gray-600'}`}>
                {step > 1 ? '✓' : '1'}
              </div>
            ...
            <div className={`flex items-center gap-2 ${step >= 2 ? 'text-[var(--primary-color)]' : 'text-gray-600'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${step >= 2 ? 'border-[var(--primary-color)] bg-[var(--primary-color)]' : 'border-gray-600'}`}>
                2
              </div>
            ...
            {step === 1 && (
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-[var(--primary-color)] text-white py-4 rounded-lg font-medium hover:bg-[var(--primary-color)]/90 transition"
                >
                  Continue to Payment
                </button>
              </div>
                ...
                <div className="bg-slate-900 rounded-lg p-6 border border-slate-800">
                  ...
                  <div className="space-y-3">
                    ...
                    <label className={`flex items-center p-4 rounded-lg border-2 cursor-pointer transition ${
                      paymentMethod === 'stripe' ? 'border-[var(--primary-color)] bg-[var(--primary-color)]/10' : 'border-slate-700 hover:border-slate-600'
                    }`}>
                      <input
                        type="radio"
                        name="paymentMethod"
                    ...
                    {/* Paystack */}
                    <label className={`flex items-center p-4 rounded-lg border-2 cursor-pointer transition ${
                      paymentMethod === 'paystack' ? 'border-[var(--primary-color)] bg-[var(--primary-color)]/10' : 'border-slate-700 hover:border-slate-600'
                    }`}>
                      <input
                        type="radio"
                        name="paymentMethod"
                    ...
                    {/* PayPal */}
                    <label className={`flex items-center p-4 rounded-lg border-2 cursor-pointer transition ${
                      paymentMethod === 'paypal' ? 'border-[var(--primary-color)] bg-[var(--primary-color)]/10' : 'border-slate-700 hover:border-slate-600'
                    }`}>
                      <input
                        type="radio"
                        name="paymentMethod"
