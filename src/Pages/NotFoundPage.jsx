                            ...
                            <div className="bg-[#1a1a1a] rounded-2xl p-8 border border-gray-800">
                                ...
                                <div className="space-y-6">
                                    {featuredProducts.map((product, index) => (
                                        <div
                                            key={index}
                                            className="group flex items-center gap-4 p-4 bg-black/50 rounded-lg hover:bg-black/70 transition-all duration-300 cursor-pointer border border-gray-800 hover:border-[var(--primary-color)]"
                                        >
                        ...
                        <div className="bg-[#1a1a1a] rounded-xl p-6 border border-gray-800">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full bg-black text-white px-6 py-4 pr-12 rounded-lg border border-gray-800 focus:border-[var(--primary-color)] focus:outline-none transition"
                                />
